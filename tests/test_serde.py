...
import uuid
import datetime
from serde import parse, dumps, ParseError
...
class TestParse(unittest.TestCase):
    ...
    def test_parse_complex(self):
        ...
        s = parse(
                ...
                type_table={datetime.datetime: lambda x: datetime.datetime.fromtimestamp(x, datetime.UTC)}
                )
        self.assertEqual(s.school.created, datetime.datetime(2020, 4, 1, tzinfo=datetime.UTC))
